...
def run():
    try:
        ...
        if result:
            ...
            recover = recover_power_fail(180)
            if recover:
                return True
            else:
                return False
        ...
        print "UT_Recover_Power_Status Except:" + str(e)


def recover_power_fail(detect_time=5):
    ...
    try:
        ...
        print "UT_Recover_Power_Status recover-power-Except:" + str(e)
        result = False
    return result
...
def detection_power_fail(detect_time=5):
    ...
    try:
        ...
        print "UT_Recover_Power_Status detect-power-Except:" + str(e)
        result = False
    return result
