...
def recover_os_fail(detect_time=5):
    ...
    try:
        ...
        print "UT_Recover_OS_Hang recover-os-Except:" + str(e)
        result = False
    return result
...
def detection_OS_fail(detect_time=5):
    ...
    try:
        ...
        print "UT_Recover_OS_Hang detect-os-Except:" + str(e)
        result = False
    return result
...
def _create_ssh_client(name, default_timeout=1):
    ...
    try:
        ...
        print "UT_Recover_OS_Hang create-ssh-Except : %s" % str(e)
        return None
...
def _check_boot_up():
    ...
    try:
        ...
        print "UT_Recover_OS_Hang check-boot-Except:" + str(e)
        return "Error"
